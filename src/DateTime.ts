...
// Derived
//──────────────────────────────────────────────────────────────────────────────
export const INSTANTS = ([] as Array<string|Date>).concat(
	INSTANT_STRINGS,
	DATE_OBJECTS
);

export const LOCAL_DATES = ([] as Array<string|Date>).concat(
	LOCAL_DATE_STRINGS,
	DATE_OBJECTS
);

export const LOCAL_DATE_TIMES = ([] as Array<string|Date>).concat(
	LOCAL_DATE_TIME_STRINGS,
	DATE_OBJECTS
);

export const LOCAL_TIMES = ([] as Array<string|Date>).concat(
	LOCAL_TIME_STRINGS,
	DATE_OBJECTS
);
